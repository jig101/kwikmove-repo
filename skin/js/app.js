...
function(a) {
    a(document).ready(function() {
        a("div#z02").animate({
            opacity: "toggle"
        }, 1e3), a(".mb-contactInfo .mb-contactInfo-wrap .action").click(function() {
            var b = a(this),
                c = b.data("content");
            a(".mb-contactInfo .mb-contactInfo-wrap .action").not(b).each(function() {
                var b = a(this),
                    c = b.data("content");
                a(".mb-contactInfo .mb-contactInfo-content " + c).hide()
            }), a(".mb-contactInfo .mb-contactInfo-content " + c).animate({
                opacity: "toggle"
            }, 1e3)
        }), a(".slick-hp").slick({
            dots: !0,
